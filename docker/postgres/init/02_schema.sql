-- ============================================================
-- Step 2: Load relational schema
-- Source: 04_relational_schema.sql
-- ============================================================
...
-- SENSOR_READING (partitioned by month)
...
CREATE TABLE sensor_reading_2025_03 PARTITION OF sensor_reading FOR VALUES FROM ('2025-03-01') TO ('2025-04-01');
CREATE TABLE sensor_reading_2025_04 PARTITION OF sensor_reading FOR VALUES FROM ('2025-04-01') TO ('2025-05-01');
CREATE TABLE sensor_reading_2025_05 PARTITION OF sensor_reading FOR VALUES FROM ('2025-05-01') TO ('2025-06-01');
CREATE TABLE sensor_reading_2025_06 PARTITION OF sensor_reading FOR VALUES FROM ('2025-06-01') TO ('2025-07-01');
CREATE TABLE sensor_reading_2026_01 PARTITION OF sensor_reading FOR VALUES FROM ('2026-01-01') TO ('2026-02-01');
CREATE TABLE sensor_reading_2026_04 PARTITION OF sensor_reading FOR VALUES FROM ('2026-04-01') TO ('2026-05-01');

-- INCIDENT (bi-temporal)
...
CREATE TABLE vehicle_incident (
    ...
    incident_id     INT     NOT NULL REFERENCES incident(incident_id),
    role            VARCHAR(30) NOT NULL DEFAULT 'INVOLVED',
...
CREATE INDEX idx_incident_current     ON incident(incident_time DESC, severity, zone_id) WHERE valid_to = 'infinity';
CREATE INDEX idx_dispatch_cover       ON dispatch(incident_id) INCLUDE (arrival_time, dispatch_time);
